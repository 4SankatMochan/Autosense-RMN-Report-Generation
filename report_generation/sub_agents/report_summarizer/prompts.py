    ...
    "1. Section Name": {
        ...
        "1.2. Another Subsection": {
            ...
            "table": {
                ...
                "caption": "Table 1: Description of table data."
            }
        }
    },
...
Task:
First use tool generate_report to generate Markdown Report. Then use format_report to generate json. Then return the json back.
