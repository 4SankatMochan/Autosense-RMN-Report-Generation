...
from report_generation.sub_agents.pdf_generator.styles_config import get_styles, get_page_settings, get_image_settings, get_table_styles, get_brand_colors, get_header_footer_settings, add_page_decor # MAX_IMAGE_WIDTH_RATIO, MAX_IMAGE_HEIGHT
