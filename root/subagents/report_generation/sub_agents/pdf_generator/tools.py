...
async def generate_pdf_report(tool_context: Optional[ToolContext] = None):    
    ...
    try:
        ...
        output_filename = f"gs://acn-cda-rmn-report-gen/root/user/{session_id}/final_report.pdf"
        clickable_filename = f"https://storage.cloud.google.com/acn-cda-rmn-report-gen/root/user/{session_id}/final_report.pdf"
