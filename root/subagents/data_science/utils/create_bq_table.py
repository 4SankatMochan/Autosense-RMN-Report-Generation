...
def main():
    ...
    # Load the train data
    print("Loading fact_performance table.")
    load_csv_to_bigquery(project_id, dataset_name, "fact_performance", fact_performance_csv_filepath)

    # Load the test data
    print("Loading fact_reach table.")
    load_csv_to_bigquery(project_id, dataset_name, "fact_reach", fact_reach_csv_filepath)
