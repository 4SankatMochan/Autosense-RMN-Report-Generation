...
# template = """Use a template suitable for the contents in Text and Visualization Summary. Include images, tables and sub sections if required.
# """
...
async def format_report(tool_context: Optional[ToolContext] = None):
  ...
  custom_prompt = f"""
**Task**
Generate JSON from the Report given below.
